...
(async()=>{
  ...
  try{
    ...
    for(const text of ['הפרפקציוניסט','מכונה גם: המחוקק, מתקן העולם','1w9','SP / SO / SX','כנף','מתוך 100','לא עבר תיקוף','ניסוי קטן','Hook'])assert.ok(html.includes(text),`report includes ${text}`);
