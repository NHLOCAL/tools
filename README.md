...
-   [ימות המשיח — מערכות וחיבורים טלפוניים](skills/yemot-telephony/) - סקיל מקיף ומתועד לבניית מערכות IVR, חיבורי API ו-SIP בימות המשיח, כולל תיעוד רשמי מלא וחיפוש מקומי
