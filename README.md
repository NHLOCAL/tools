...
-   [ימות המשיח - מערכות טלפוניות](skills/yemot-telephony/) - סקיל מקיף ומתועד לבניית מערכות IVR, חיבורי API ו-SIP בימות המשיח, כולל תיעוד רשמי מלא וחיפוש מקומי
...
-   [עורך HTML חי](tools/html_editor.html) - כלי לכתיבה ועריכה של קוד HTML עם תצוגה מקדימה חיה.
...
-   [מבחן 16 הטיפוסים](tools/the_16_types.html) - שאלון עצמאי בעברית בהשראת MBTI, עם 56 שאלות, שמירת התקדמות ותוצאה מפורטת. פועל גם ללא חיבור לרשת.
