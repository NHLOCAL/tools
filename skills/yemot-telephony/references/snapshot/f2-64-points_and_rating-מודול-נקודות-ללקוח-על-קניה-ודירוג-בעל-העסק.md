...
Source kind: `f2`
Topic ID: `64`
Topic source: https://f2.freeivr.co.il/topic/64

## Post 0 — ימות המשיח — topic author

Post ID: `85`
Published: `2020-05-18T18:40:25.444Z`
Updated: `2024-02-06T14:44:18.213Z`
Source: https://f2.freeivr.co.il/post/85
...
## [](https://f2.freeivr.co.il)תרגום ymgr לעברית

PointsAndRatingLog.ini

```
PointsAndRatingLog=דו"ח נקודות ודירוג
Type=סוג זיהוי
...
Part=דירוג
Part-1=שירות והעמידה בזמנים
Part-2=מקצועיות
Part-3=מחיר
RatingAdd= נקודות דירוג עכשווי
TotalRating=נקודות דירוג מצטבר
TotalId=כמות מדרגים
Average=ממוצע דירוג
Amount=סכום ששולם לעסק
PointsAdd=נקודות על העיסקה
PointsTotal=סה"כ נקודות ללקוח
